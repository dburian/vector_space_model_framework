 ...
 *
 *         Czech stemmer-removes case endings form nouns and adjetives,
 *         possesive adj.
 *         endings from names
 *         and takes care of palatalisation
 */
public class CzechStemmerLight extends StemmerTermPipeline {
  /**
  ...
  public CzechStemmerLight(TermPipeline _next) {
    this.next = _next;
  }
